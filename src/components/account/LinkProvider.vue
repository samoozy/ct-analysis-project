<template>
  <div>
    <button 
      class="focus:outline-none text-gray-500 flex items-center justify-center rounded py-2 px-3 border border-gray-200 shadow"
      @click="linkToGoogleProvider"
    >
